...
async function getStudent(id: number | string): Promise<any> {
...
async function deleteStudent(id: number | string): Promise<void> {
  let student = await Student.findByPk(id);
  if (!student) throw Error('404');
...
async function getClasses(id: number | string): Promise<any[]> {
...
async function addClass(
  ...
  if (!student || !_class) throw Error('404');
...
async function deleteClasses(id: number | string): Promise<void> {
  let student = await Student.findByPk(id);
  if (!student) throw Error('404');
...
async function getTeachers(id: number | string): Promise<any[]> {
